...
# 4.1 tproj スクリプト
CORE_BINS=(tproj tproj-drop-column tproj-toggle-yazi tproj-pane-focus-hook tproj-pane-clear-rank agent-monitor team-watcher reflow-agent-pane rebalance-workspace-columns sign-codex wait-for-pane-text)
